            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <span
                    className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${savedRoom.status === "Active" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`}
                  >
                    {savedRoom.status}
                  </span>
                </div>
                  ...
                  {upcomingBookings.length > 0 ? (
                    <div className="space-y-2 max-h-[150px] overflow-y-auto pr-1">
                      {upcomingBookings.map((booking, idx) => (
                        <div
                          key={idx}
                          className="bg-blue-50 p-2 rounded border border-blue-100 animate-in fade-in zoom-in duration-300"
                        >
                          <span className="font-medium block text-blue-900">
                            {booking.event_name}
                          </span>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4 text-sm max-h-[400px] overflow-y-auto pr-2">
                {/* Physical Specs */}
                <div>
                  <h4 className="font-semibold mb-2 text-muted-foreground uppercase text-xs">
                    Physical Specs
                  </h4>
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    {Object.entries(savedRoom.physical_specs || {}).map(
                      ([key, val]) =>
                        val && (
                ...
                {/* Equipment: Furniture */}
                {savedRoom.equipment?.furniture &&
                  Object.values(savedRoom.equipment.furniture).some((v) => v) && (
                    <div>
                      <h4 className="font-semibold mb-2 text-muted-foreground uppercase text-xs mt-4">
                        Furniture
                      </h4>
                      <div className="grid grid-cols-2 gap-2">
                        {Object.entries(savedRoom.equipment.furniture).map(
                          ([key, val]) =>
                            val && (
                              <div key={key} className="flex justify-between border-b pb-1">
                                <span className="text-muted-foreground capitalize">
                ...
                {/* Accessibility */}
                {savedRoom.accessibility &&
                  Object.values(savedRoom.accessibility).some((v) => v) && (
                    <div>
                      <h4 className="font-semibold mb-2 text-muted-foreground uppercase text-xs mt-4">
                        Accessibility
                      </h4>
                        ...
                        {Object.entries(savedRoom.accessibility).map(([key, val]) => {
                          ...
                          if (typeof val === "boolean") {
                            return (
                              <span
                                key={key}
                                className="px-2 py-1 bg-blue-50 text-blue-700 rounded text-xs border border-blue-100 capitalize"
                              >
                                {key.replace(/_/g, " ")}
                              </span>
                            );
      ...
      <div className="flex justify-between items-center shrink-0">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            {watch("room_name") || "Enter room details"}
          </p>
        </div>
            ...
            <Card>
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    value={`BLD-01-FL-${watch("floor_number") || "X"}-RM-${watch("room_number") || "XXX"}`}
                    disabled
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(v) => setValue("room_type", v)}
            ...
            <Card>
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    type="number"
                    {...register("physical_specs.window_area")}
                    placeholder="For natural light"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium">Flooring Type</label>
                  <Select
                    onValueChange={(v) => setValue("physical_specs.flooring", v)}
                    value={watch("physical_specs.flooring")}
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Select type" />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(v) => setValue("physical_specs.paint_condition", v)}
                    value={watch("physical_specs.paint_condition")}
                  >
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={(v) => setValue("physical_specs.ceiling", v)}
                    value={watch("physical_specs.ceiling")}
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Select type" />
                    </SelectTrigger>
            ...
            <Card>
              ...
              <CardContent className="pt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="space-y-1 col-span-2">
                  ...
                  <Input
                    {...register("equipment.furniture.chair_type")}
                    placeholder="e.g. Wooden with writing pad"
                  />
                </div>
                <div className="space-y-1">
              ...
              <CardContent className="pt-4 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2 border p-3 rounded bg-card">
                    ...
                    {watch("equipment.technology.has_projector") && (
                      <Input
                        className="h-8 mt-2"
                        placeholder="Type (e.g. Epson 4K)"
                        {...register("equipment.technology.projector_type")}
                      />
                    )}
                  </div>
                  <div className="space-y-2 border p-3 rounded bg-card">
                    ...
                    {watch("equipment.technology.has_screen") && (
                      <Input
                        className="h-8 mt-2"
                        placeholder="Size (e.g. 100 inch)"
                        {...register("equipment.technology.screen_size")}
                      />
                    )}
                  </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="space-y-1 col-span-2">
                    ...
                    <Input
                      {...register("equipment.technology.computer_specs")}
                      placeholder="i5, 16GB RAM..."
                    />
                  </div>
                  <div className="space-y-1">
                  ...
                  <div className="flex items-center space-x-2 pt-6">
                    ...
                    />
                    <label htmlFor="doc_cam" className="text-sm font-medium">
                      Doc Camera
                    </label>
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className="pt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <Select
                    onValueChange={(v) => setValue("equipment.utilities.light_type", v)}
                    value={watch("equipment.utilities.light_type")}
                  >
                    <SelectTrigger className="h-9">
                      <SelectValue placeholder="Select" />
                    </SelectTrigger>
                    <SelectContent>
                      {["LED", "CFL", "Incandescent"].map((t) => (
                        <SelectItem key={t} value={t}>
                          {t}
                        </SelectItem>
                      ))}
          ...
          <TabsContent value="accessibility" className="mt-0">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Compliance checklist for Persons with Disabilities.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center justify-between border p-3 rounded-md">
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <label htmlFor="ramps" className="text-sm font-medium cursor-pointer">
                        Ramps in Room
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="border p-3 rounded-md space-y-2">
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <label htmlFor="toilet" className="text-sm font-medium cursor-pointer">
                    ...
                    {watch("accessibility.accessible_toilet") && (
                      <Input
                        className="h-8"
                        placeholder="Distance to toilet (meters)"
                        {...register("accessibility.toilet_distance")}
                      />
                    )}
                  </div>
                  ...
                  <div className="border p-3 rounded-md space-y-2">
                    ...
                    {watch("accessibility.accessible_parking") && (
                      <Input
                        className="h-8"
                        placeholder="Distance to parking (meters)"
                        {...register("accessibility.parking_distance")}
                      />
                    )}
                  </div>
                  ...
                  <div className="flex items-center justify-between border p-3 rounded-md">
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <label htmlFor="tactile" className="text-sm font-medium cursor-pointer">
                        Tactile Flooring
                      </label>
                    </div>
                  </div>
                  <div className="flex items-center justify-between border p-3 rounded-md">
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <label htmlFor="braille" className="text-sm font-medium cursor-pointer">
                        Braille Signage/Labels
                      </label>
                    </div>
                  </div>
                  <div className="flex items-center justify-between border p-3 rounded-md">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-4">
                      <Input
                        ...
                        max="10"
                        className="flex-1"
                        {...register("maintenance.cleanliness_score", { valueAsNumber: true })}
                      />
                      <span className="font-bold text-lg border p-2 rounded w-12 text-center">
                        {watch("maintenance.cleanliness_score") || "-"}
                      </span>
                    </div>
                  </div>
                  <div className="space-y-2">
              ...
              <Card>
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      {...register("allocation.dept_assigned")}
                  ...
                  <div className="space-y-2 col-span-2">
                    ...
                    <Textarea
                      placeholder="9-10 AM: CSE A..."
                      {...register("allocation.daily_schedule")}
                    />
                  </div>
                </CardContent>
              </Card>
