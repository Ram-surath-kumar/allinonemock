  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const cleanedData = {
        ...
        seating_capacity:
          formData.seating_capacity === "" ? null : parseInt(formData.seating_capacity),
        year_of_manufacture:
          formData.year_of_manufacture === "" ? null : parseInt(formData.year_of_manufacture),
        fuel_tank_capacity:
          formData.fuel_tank_capacity === "" ? null : parseFloat(formData.fuel_tank_capacity),
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter the mandatory vehicle registration and identification details.
          </DialogDescription>
        </DialogHeader>
