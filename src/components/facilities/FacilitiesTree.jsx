  ...
  return (
    <div className="select-none">
      ...
      >
        ...
        <Icon
          className={cn("h-4 w-4 mr-2", isSelected ? "text-primary" : "text-muted-foreground/70")}
        />
...
export function FacilitiesTree({ data, onSelectRoom, selectedRoomId }) {
  ...
  if (data.length === 0)
    return <div className="text-sm text-muted-foreground p-4">No buildings found.</div>;
