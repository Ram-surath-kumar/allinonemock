  ...
  const getCardTheme = () => {
    if (gradient.includes("blue")) {
      return {
        ...
        hoverGradient:
          "from-blue-50/80 via-indigo-50/60 to-purple-50/80 dark:from-blue-500/10 dark:via-indigo-500/8 dark:to-purple-500/10",
      ...
      return {
        ...
        hoverGradient:
          "from-emerald-50/80 via-teal-50/60 to-cyan-50/80 dark:from-emerald-500/10 dark:via-teal-500/8 dark:to-cyan-500/10",
      ...
      return {
        ...
        hoverGradient:
          "from-amber-50/80 via-orange-50/60 to-yellow-50/80 dark:from-amber-500/10 dark:via-orange-500/8 dark:to-yellow-500/10",
      ...
      return {
        ...
        hoverGradient:
          "from-purple-50/80 via-pink-50/60 to-rose-50/80 dark:from-purple-500/10 dark:via-pink-500/8 dark:to-rose-500/10",
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1 min-w-0">
            <p className="text-xs font-medium text-muted-foreground mb-1.5" aria-label={title}>
              {title}
            </p>
            <p
      ...
      <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-60 transition-opacity duration-300 pointer-events-none">
        <div className={cn("absolute inset-0 rounded-2xl blur-2xl", theme.hoverGlow)} />
      </div>
    </div>
  );
}
