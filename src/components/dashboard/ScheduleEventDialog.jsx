...
export function ScheduleEventDialog({ open, onOpenChange }) {
    ...
    const showDepartment = selectedRoles && selectedRoles.length > 0 && selectedRoles.every(role => ['student', 'teacher'].includes(role));
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto w-[95vw]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Schedule a new event for specific roles.
                    </DialogDescription>
                </DialogHeader>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>
                                                    Only for selected Students/Teachers.
                                                </FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                        ...
                                        >
                                            ...
                                            <div className="flex flex-wrap gap-1">
                                                {event.recipient_roles?.map((role, i) => (
                                                    <span key={i} className="text-[10px] bg-muted px-1.5 py-0.5 rounded text-muted-foreground capitalize">
                                                        {role.replace('_', ' ')}
                                                    </span>
                                                ))}
                                            </div>
