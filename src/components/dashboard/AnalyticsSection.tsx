...
export function AnalyticsSection() {
  const [attendanceView, setAttendanceView] = useState<ChartViewType>('area');
  const [feeView, setFeeView] = useState<ChartViewType>('bar');
  const [studentGrowthView, setStudentGrowthView] = useState<ChartViewType>('line');
  const [todaySummaryView, setTodaySummaryView] = useState<'pie' | 'table'>('pie');
