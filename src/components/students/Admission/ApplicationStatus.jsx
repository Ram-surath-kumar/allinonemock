      ...
      <CardContent className="pt-6 space-y-4">
        ...
        <div className="grid gap-2 text-sm">
          <div className="flex items-center gap-2">
            <CheckCircle2
              className={`h-4 w-4 ${step >= 1 ? "text-green-500" : "text-muted-foreground"}`}
            />
          ...
          <div className="flex items-center gap-2">
            <div
              className={`h-4 w-4 rounded-full border-2 flex items-center justify-center ${step >= 2 ? "border-green-500 bg-green-500 text-white" : "border-muted-foreground"}`}
            >
          ...
          <div className="flex items-center gap-2">
            <div
              className={`h-4 w-4 rounded-full border-2 flex items-center justify-center ${step >= 4 ? "border-green-500 bg-green-500 text-white" : "border-muted-foreground"}`}
            >
          ...
          <div className="flex items-center gap-2">
            <div
              className={`h-4 w-4 rounded-full border-2 flex items-center justify-center ${step >= 5 ? "border-green-500 bg-green-500 text-white" : "border-muted-foreground"}`}
            >
