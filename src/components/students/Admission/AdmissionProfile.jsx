    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold">
              {profile.personal_info?.first_name || "Student Name"}
            </h2>
            <p className="text-muted-foreground">
              {profile.admission_number || "Admission No: Pending"}
            </p>
          </div>
        </div>
      ...
      <Tabs defaultValue="personal" className="w-full">
        <TabsList className="grid w-full grid-cols-6 h-auto">
          ...
          <TabsTrigger value="address" className="py-3">
          ...
          <TabsTrigger value="guardian" className="py-3">
            <Contact className="h-4 w-4 mr-2" /> Family
          </TabsTrigger>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="md:col-span-2">
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        updateNested("address_info", "street", e.target.value, "current")
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateNested("address_info", "city", e.target.value, "current")
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateNested("address_info", "state", e.target.value, "current")
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateNested("address_info", "zip", e.target.value, "current")
                      }
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="md:col-span-2">
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        updateNested("address_info", "street", e.target.value, "permanent")
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateNested("address_info", "city", e.target.value, "permanent")
                      }
                    />
                  </div>
                </div>
        ...
        <TabsContent value="guardian">
          <Card>
            <CardHeader>
              <CardTitle>Parent / Guardian Info</CardTitle>
            </CardHeader>
                ...
                <div className="space-y-4 border p-4 rounded-md">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateNested("guardian_info", "name", e.target.value, "father")
                      }
                    />
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateNested("guardian_info", "occupation", e.target.value, "father")
                      }
                    />
                    <Label>Phone</Label>
                    <Input
                      ...
                      onChange={(e) =>
                        updateNested("guardian_info", "phone", e.target.value, "father")
                      }
                    />
                  </div>
                </div>
                <div className="space-y-4 border p-4 rounded-md">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateNested("guardian_info", "name", e.target.value, "mother")
                      }
                    />
                    <Label>Occupation</Label>
                    <Input
                      ...
                      onChange={(e) =>
                        updateNested("guardian_info", "occupation", e.target.value, "mother")
                      }
                    />
                    <Label>Phone</Label>
                    <Input
                      ...
                      onChange={(e) =>
                        updateNested("guardian_info", "phone", e.target.value, "mother")
                      }
                    />
                  </div>
                </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    updateNested("medical_history", "chronic_illness", e.target.value)
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateNested("medical_history", "doctor_contact", e.target.value)
                  }
                />
              </div>
            </CardContent>
        ...
        <TabsContent value="demographics">
          <Card>
            <CardHeader>
              <CardTitle>Demographics & Categories</CardTitle>
            </CardHeader>
                ...
                <div className="space-y-4 border p-4 rounded-md">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateNested("personal_info", "enrollment_status", e.target.value)
                      }
                    />
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateNested("personal_info", "admission_category", e.target.value)
                      }
                    />
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateNested("personal_info", "is_first_generation", e.target.checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                    ...
                    {profile.personal_info?.is_pwd && (
                      <Input
                        ...
                        onChange={(e) =>
                          updateNested("personal_info", "disability_type", e.target.value)
                        }
                      />
                    )}
                  </div>
        ...
        <TabsContent value="documents">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload necessary documents. (Storage integration required)
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
