    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Select onValueChange={(v) => setFormData({ ...formData, course_applied: v })}>
          ...
          <SelectContent>
            <SelectItem value="B.Tech Computer Science">
      ...
      <div className="border rounded-lg p-4 bg-muted/20 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              onValueChange={(v) => setFormData({ ...formData, student_status: v })}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
          <div className="flex items-center space-x-2">
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, is_first_generation_learner: e.target.checked })
              }
            />
