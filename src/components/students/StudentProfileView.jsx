            ...
            <CardContent>
              <div className="space-y-2">
                ...
                {isEditing ? (
                  ...
                  <p className="p-3 bg-muted/20 rounded-md text-sm">
...
function AcademicTab({ userId }) {
  ...
  if (loading)
    return <div className="p-4 text-center text-muted-foreground">Loading academic records...</div>;
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{record.semester || "N/A"}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{record.gpa ? record.gpa.toFixed(2) : "-"}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{record.credits_earned || 0}</div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <CreditCard className="h-5 w-5" /> Current Enrollments
          </CardTitle>
        </CardHeader>
        <CardContent>
