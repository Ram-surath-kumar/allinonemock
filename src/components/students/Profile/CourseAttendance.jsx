                ...
                <Card key={course.course_offering_id} className="relative overflow-hidden">
                    <CardHeader className="pb-2">
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <CardDescription className="text-xs truncate max-w-[180px]" title={course.course_name}>
                                    {course.course_name}
                                </CardDescription>
                            </div>
                            <div className="text-right">
                                <span className={`text-2xl font-bold ${course.percentage < 75 ? 'text-destructive' : 'text-green-600'}`}>
                                    {course.percentage}%
                                </span>
                            </div>
                        </div>
                    ...
                    <CardContent>
                        ...
                        <div className="flex justify-between text-xs text-muted-foreground mt-2">
                            ...
                            <span>Present: <span className="font-medium text-foreground">{course.present}</span></span>
                        </div>
