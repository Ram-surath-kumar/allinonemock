          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs font-semibold">
                Ends {new Date(addDropPeriod.add_drop_end_date).toLocaleDateString()}
              </span>
            </div>
          </div>
        )}
                  ...
                  <CardContent className="p-6 pt-0">
                    <div className="flex items-center justify-between mb-6 text-sm">
                      <div className="flex flex-col">
                        ...
                        <span className="font-semibold">
                          {reg.offering?.faculty_name || "Staff"}
                        </span>
                      </div>
                    ...
                    >
                      <span className="group-hover:hidden flex items-center gap-2">
                        <CheckCircle2 size={14} className="text-emerald-500" /> Active Registry
                      </span>
                      ...
                      <div className="flex items-center justify-end gap-2">
                        <div
                          className={cn(
                            ...
                            reg.status === "Dropped" ? "bg-destructive" : "bg-emerald-500"
                          )}
                        />
                        <span
                          className={cn(
                            "text-xs font-bold uppercase",
                            reg.status === "Dropped" ? "text-destructive" : "text-emerald-600"
                          )}
                        >
                          {reg.status}
                        </span>
