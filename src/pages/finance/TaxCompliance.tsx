      ...
      <CardContent className="space-y-4 max-w-md">
        <div className="space-y-2">
          ...
          <Input
            ...
            value={config.gst_no}
            onChange={(e) => setConfig({ ...config, gst_no: e.target.value })}
          />
        </div>
        <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => setConfig({ ...config, tds_rate: Number(e.target.value) })}
          />
        </div>
          ...
          <TableBody>
            {data.map((row, i) => (
              <TableRow key={i}>
                ...
                <TableCell>
                  <span className="text-yellow-600 font-medium">Pending Filing</span>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
