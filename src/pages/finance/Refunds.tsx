        ...
        <Card>
            ...
            <CardContent>
                <Table>
                    ...
                    <TableBody>
                        {refunds.length === 0 ? (
                            <TableRow><TableCell colSpan={6} className="text-center">No refund requests found</TableCell></TableRow>
                        ) : (
                            refunds.map(r => (
                                <TableRow key={r.id}>
                                    <TableCell>
                                    ...
                                    <TableCell>
                                        {r.status === 'requested' && (
                                            <div className="flex gap-2">
                                                <Button size="sm" variant="outline" className="text-green-600 border-green-600 hover:bg-green-50" onClick={() => handleApprove(r.id, 'approved')}>Approve</Button>
                                                <Button size="sm" variant="outline" className="text-red-600 border-red-600 hover:bg-red-50" onClick={() => handleApprove(r.id, 'rejected')}>Reject</Button>
                                            </div>
                                        )}
                                    </TableCell>
                                </TableRow>
