        ...
        try {
            ...
            if (json.success) {
                toast({
                    ...
                    description: "The MIS report has been successfully generated.",
                });
                fetchReports();
            } else {
    ...
    return (
        <div className="p-6 space-y-6">
            <div className="flex justify-between items-center">
                <h1 className="text-3xl font-bold tracking-tight">MIS Data Submission</h1>
            </div>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Select value={reportType} onValueChange={setReportType}>
                                    ...
                                    <SelectContent>
                                        <SelectItem value="AICTE">AICTE Compliance</SelectItem>
                                        <SelectItem value="UGC">UGC Annual Report</SelectItem>
                                        <SelectItem value="NIRF">NIRF Data</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                            <div className="space-y-2">
                        ...
                        <Button
                            ...
                            disabled={generating}
                        >
                            {generating ? 'Aggregating Data...' : 'Generate Report'}
                        </Button>
                        <p className="text-xs text-muted-foreground text-center">
                            This will aggregate data from Student, Faculty, and Placement modules.
                        </p>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between border-b pb-2">
                                <span className="text-sm font-medium">AICTE Status</span>
                                <Badge variant="default" className="bg-green-500">Submitted</Badge>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-sm font-medium">UGC Status</span>
