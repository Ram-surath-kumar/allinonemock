...
export function AllocationDialog({ open, onOpenChange, onSuccess, hostels, rooms }: AllocationDialogProps) {
        ...
        try {
            ...
            if (studentsRes.data) {
                ...
                if (studentsRes.data.length > 0) {
                    console.log('First student ID:', studentsRes.data[0].id, 'Type:', typeof studentsRes.data[0].id);
            ...
            const allocationsRes = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:3001/api'}/hostel/allocations`);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:3001/api'}/hostel/allocations`, {
                method: 'POST',
                                        ...
                                        return (
                                            <SelectItem key={r.id} value={r.id}>
                                                <div className="flex items-center justify-between w-full">
                                                    <span>Floor {r.floor_number} - Room {r.room_number}</span>
                        ...
                        <div className="bg-primary/10 border border-primary/20 rounded-lg p-3 flex items-center gap-3">
                            ...
                            <div className="flex-1">
                                <div className="text-sm font-medium">
                                    {selectedRoomOccupancy.available} Bed{selectedRoomOccupancy.available !== 1 ? 's' : ''} Available
                                </div>
