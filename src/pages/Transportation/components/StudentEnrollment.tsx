          ...
          <Card className="animate-in slide-in-from-left-4">
            ...
            <CardContent className="space-y-4">
                ...
                {selectedRoute && (
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <Label>Pickup</Label>
                      <Select
                        onValueChange={(v) => setFormData({ ...formData, pickup_point_id: v })}
                      >
                        <SelectTrigger>
                    ...
                    <div>
                      ...
                      <Select
                        onValueChange={(v) => setFormData({ ...formData, preferred_seating: v })}
                        defaultValue="Window"
                      >
                        <SelectTrigger>
                          <SelectValue />
              ...
              <div className="space-y-3 p-3 border rounded bg-red-50 dark:bg-red-900/10">
                <Label className="flex items-center gap-2 text-red-700 dark:text-red-400 font-semibold">
                  <HeartPulse className="h-4 w-4" /> Medical & Emergency
                </Label>
                <div className="grid grid-cols-2 gap-2">
